      ...
      <div className="prueba">
        <div className="contenedor-slide">
          <div className="contenedor1">
            <button onclick="window.location.href='/tShirts'" className="Top">
              T-Shirts
            </button>
            <div
              className="panel"
          ...
          <div className="contenedor2">
            <button onclick="window.location.href='/socks'" className="Top1">
              Funky Socks
            </button>
            <div
              className="panel"
          ...
          <div className="contenedor3">
            <button onclick="window.location.href='/bags'" className="Top2">
              Hacker Bags
            </button>
            <div
              className="panel"
              onclick="window.location.href='/bags'"
              style={{
          ...
          <div className="contenedor4">
            <button onclick="window.location.href='/hoodies'" className="Top3">
              Hoodies
            </button>
            <div
              className="panel"
          ...
          <div className="contenedor5">
            <button onclick="window.location.href='/hats'" className="Top4">
              Hats
            </button>
            <div
              className="panel"
              onclick="window.location.href='/hats'"
              style={{
